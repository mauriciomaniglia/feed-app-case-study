...
//  EssentialFeedTests
//
//  Created by Mauricio Cesar Maniglia Junior on 17/10/19.
...
class CodableFeedStoreTests: XCTestCase {
    ...
    private func expect(sut: FeedStore, toRetrieveTwice expectedResult: RetrieveCachedFeedResult, file: StaticString = #file, line: UInt = #line) {
